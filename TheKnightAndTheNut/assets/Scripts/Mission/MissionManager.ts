...
export class MissionManager extends Component {
  ...
  private missions: { key: string; islocked: boolean; score: number, image: SpriteFrame, time: number }[] = [
    { key: KeyMission.MISSION_1, islocked: false, score: 500, image: null, time: 60 },
    { key: KeyMission.MISSION_2, islocked: true, score: 700, image: null, time: 70 },
    { key: KeyMission.MISSION_3, islocked: true, score: 800, image: null, time: 80 },
  ];
